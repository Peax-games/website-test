...
export default function MultiPlayerGenreViewpg2() {

    return (
        <div className="arcade-root">
            <p className="arcade-genre-header">Multiplayer Games Pg. 2</p>
            <div className="genreViewPageLinks">
                <Link to="/multiplayer">&laquo;</Link>
                <Link to="/multiplayer">1</Link>
                <Link className="active" to="/multiplayer/page-2">2</Link>
